<template>
  <div class="container mx-auto p-4 my-8">
    ...
    <div v-else-if="product" class="bg-white shadow-lg rounded-lg p-6">
      ...
      <button @click="handleAddToCart" class="bg-orange-600 text-white px-8 py-3 rounded-lg hover:bg-orange-700 text-xl font-semibold transition-colors duration-200">
